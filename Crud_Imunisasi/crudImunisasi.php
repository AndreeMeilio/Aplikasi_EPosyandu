...
<div id="content1" style="margin-left: 230px; margin-top: 130px;">
  ...
  <button onclick="window.location.href='http://eposyandu.astakaryakreatif.com/formtambah.php'" class="btn shadow-sm p-2 bg-success rounded" id="button" style="margin-top: 10px;">Tambah Data Imunisasi</button><br><br>
  ...
  <br>
  <span id="status"></span>
	<button onclick="window.location.href='http://eposyandu.astakaryakreatif.com/home3.php'" class="btn shadow-sm p-2 bg-success rounded" id="button">Kembali</button><br><br><br>
</div>
      ...
      $.ajax({
          ...
          var content = "";
            for (let index = 0; index < data.length; index++) {
              ...
              '<td><button onclick="window.location.href=\'http://eposyandu.astakaryakreatif.com/formedit.php?id_imunisasi='+ element.id_imunisasi +'\'" class="btn btn-info" style="padding: 0px 10px 0px 10px;">EDIT</button></td>' +
