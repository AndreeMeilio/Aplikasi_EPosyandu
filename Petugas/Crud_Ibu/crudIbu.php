...
<body> 
  ...
  ?>
  	<div id="content1" style="margin-left: 230px; margin-top: 130px;">
  			<h1>Data Ibu</h1>
  			<button type="button" onclick="window.location.href='http://eposyandu.astakaryakreatif.com/Petugas/Crud_Ibu/formTambahIbu.php'"class="btn shadow-sm p-2 bg-success rounded" id="button" style="margin-top: 10px;">Tambah Data Ibu</button> <br><br>
				<table id="ttable" border="0" class="table table-hover table-light table-striped">
				 ...
				 <br>
		  <span id="status"></span>
		  <button type="button" onclick="window.location.href='http://eposyandu.astakaryakreatif.com/Petugas/home3.php'" class="btn shadow-sm p-2 bg-success rounded" id="button">Kembali</button><br><br>
	</div>
<!-- 
